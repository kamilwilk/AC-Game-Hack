...
public:
	...
	//like printf
	void string(GLfloat x, GLfloat y, GLubyte r, GLubyte g, GLubyte b, GLubyte alpha, void * font, char const*const pFmtText, ...);
	//Draws a filled box. xLen is the length of the left and right sides, yLen is the length of the top and bottom
	void box(GLfloat x, GLfloat y, GLfloat xLen, GLfloat yLen, GLubyte r, GLubyte g, GLubyte b, GLubyte alpha);
	//Same as box, though it draws just the outline. Width is how thick you want the line to be
	void boxLine(GLfloat width, GLfloat x, GLfloat y, GLfloat xLen, GLfloat yLen, GLubyte r, GLubyte g, GLubyte b, GLubyte alpha);
